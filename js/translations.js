...
const translations = {
  sl: {
    ...
    enterCompanyName: "Vnesite naziv podjetja",
    enterTaxNumber: "Vnesite davčno številko",
    enterRegistrationNumber: "Vnesite matično številko",
    enterCompanyAddress: "Vnesite naslov podjetja",
    enterCompanyCity: "Vnesite mesto",
    enterCompanyCountry: "Vnesite državo",
    enterCurrentPassword: "Vnesite trenutno geslo",
    enterNewPassword: "Vnesite novo geslo",
    enterConfirmNewPassword: "Potrdite novo geslo",
    ...
    forgotPasswordInstructions: "Vnesite vaš e-poštni naslov. Prejeli boste e-pošto s povezavo za ponastavitev gesla.",
    sendResetEmail: "Pošlji e-pošto za ponastavitev",
    newPassword: "Novo geslo",
    currentPassword: "Trenutno geslo",
    changePassword: "Spremeni geslo",
    accountSecurity: "Varnost računa",
    manualDimensions: "Ročno vnos",
    length: "Dolžina",
    width: "Širina",
    height: "Višina",
    ...
    companyInfoTitle: "Podatki o podjetju",
    companyInfoPageTitle: "Podatki o podjetju - FURA",
    companyNameTitle: "Naziv podjetja",
    companyFullName: "Dolgi naziv:",
    companyStatusTitle: "Status podjetja",
    companyStatusActive: "Aktivna",
    companyAddressTitle: "Naslov podjetja",
    registrationDetailsTitle: "Registracijski podatki",
    taxNumber: "Davčna številka (DŠ)",
    registrationNumber: "Matična številka (MŠ)",
    registrationDate: "Datum vpisa",
    registerAsCompany: "Registriraj se kot podjetje",
    companyInformation: "Podatki o podjetju",
    companyName: "Naziv podjetja",
    companyAddress: "Naslov podjetja",
    companyCity: "Mesto",
    companyCountry: "Država",
    noCompanyRegistered: "Nimate registriranega podjetja.",
    registerCompany: "Registriraj podjetje",
    editCompanyInfo: "Uredi podatke o podjetju",
    saveCompanyInfo: "Shrani podatke o podjetju",
    loadingCompanyInfo: "Nalaganje podatkov o podjetju...",
    passwordResetRateLimitExceeded: "Geslo lahko ponastavite le enkrat dnevno.",
    businessDetailsTitle: "Poslovni podatki",
    skdActivity: "SKD dejavnost",
    companySize: "Velikost podjetja",
    registrationAuthority: "Registrski organ",
    vatRegistered: "Zavezanec za DDV",
    vatYes: "DA",
    capitalOrigin: "Poreklo kapitala",
    capitalNotDetermined: "Kapital se ne določa",
  ...
  en: {
    ...
    enterCompanyCity: "Enter city",
    enterCompanyCountry: "Enter country",
    ...
    companyInfoPageTitle: "Company Information - FURA",
    companyNameTitle: "Company Name",
    companyFullName: "Full Name:",
    ...
    taxNumber: "Tax Number (DŠ)",
    registrationNumber: "Registration Number (MŠ)",
    registrationDate: "Registration Date",
    registerAsCompany: "Register as a company",
    companyInformation: "Company Information",
    companyName: "Company Name",
    companyAddress: "Company Address",
    companyCity: "City",
    companyCountry: "Country",
    noCompanyRegistered: "You don't have a registered company.",
    registerCompany: "Register Company",
    editCompanyInfo: "Edit Company Information",
    saveCompanyInfo: "Save Company Information",
    loadingCompanyInfo: "Loading company information...",
    passwordResetRateLimitExceeded: "You can reset your password only once per day.",
    ...
    skdActivity: "SKD Activity",
    companySize: "Company Size",
    registrationAuthority: "Registration Authority",
    vatRegistered: "VAT Registered",
    vatYes: "YES",
    capitalOrigin: "Capital Origin",
    capitalNotDetermined: "Capital not determined",
  ...
  sr: {
    ...
    enterCompanyName: "Унесите назив предузећа",
    enterTaxNumber: "Унесите порески број",
    enterRegistrationNumber: "Унесите матични број",
    enterCompanyAddress: "Унесите адресу предузећа",
    enterCompanyCity: "Унесите град",
    enterCompanyCountry: "Унесите земљу",
    enterCurrentPassword: "Унесите тренутну лозинку",
    enterNewPassword: "Унесите нову лозинку",
    enterConfirmNewPassword: "Потврдите нову лозинку",
    ...
    about: "О нама",
    companyDetails: "Подаци о предузећу",
    companyInfoTitle: "Подаци о предузећу",
    companyInfoPageTitle: "Подаци о предузећу - FURA",
    companyNameTitle: "Назив предузећа",
    companyFullName: "Пуни назив:",
    companyStatusTitle: "Статус предузећа",
    companyStatusActive: "Активно",
    companyAddressTitle: "Адреса предузећа",
    registrationDetailsTitle: "Подаци о регистрацији",
    taxNumber: "Порески број (ДШ)",
    registrationNumber: "Матични број (МШ)",
    registrationDate: "Датум уписа",
    registerAsCompany: "Региструј се као предузеће",
    companyInformation: "Подаци о предузећу",
    companyName: "Назив предузећа",
    companyAddress: "Адреса предузећа",
    companyCity: "Град",
    companyCountry: "Земља",
    noCompanyRegistered: "Немате регистровано предузеће.",
    registerCompany: "Региструј предузеће",
    editCompanyInfo: "Уреди податке о предузећу",
    saveCompanyInfo: "Сачувај податке о предузећу",
    loadingCompanyInfo: "Учитавање података о предузећу...",
    passwordResetRateLimitExceeded: "Лозинку можете поново поставити само једном дневно.",
    accountSecurity: "Безбедност налога",
    currentPassword: "Тренутна лозинка",
    newPassword: "Нова лозинка",
    changePassword: "Промени лозинку",
    forgotPassword: "Заборавили сте лозинку?",
    forgotPasswordTitle: "Заборављена лозинка",
    forgotPasswordInstructions: "Унесите вашу емаил адресу. Добићете емаил са везом за ресетовање лозинке.",
    businessDetailsTitle: "Пословни подаци",
    skdActivity: "СКД делатност",
    companySize: "Величина предузећа",
    registrationAuthority: "Регистарски орган",
    vatRegistered: "Обавезан за ПДВ",
    vatYes: "ДА",
    capitalOrigin: "Порекло капитала",
    capitalNotDetermined: "Капитал се не одређује",
    contactInfoTitle: "Контакт информације",
    contact: "Контакт",
  ...
  it: {
    ...
    enterCompanyName: "Inserisci il nome azienda",
    enterTaxNumber: "Inserisci il numero fiscale",
    enterRegistrationNumber: "Inserisci il numero di registrazione",
    enterCompanyAddress: "Inserisci l'indirizzo azienda",
    enterCompanyCity: "Inserisci la città",
    enterCompanyCountry: "Inserisci il paese",
    enterCurrentPassword: "Inserisci la password attuale",
    enterNewPassword: "Inserisci la nuova password",
    enterConfirmNewPassword: "Conferma la nuova password",
    ...
    companyInfoPageTitle: "Informazioni aziendali - FURA",
    companyNameTitle: "Nome azienda",
    companyFullName: "Nome completo:",
    companyStatusTitle: "Stato azienda",
    companyStatusActive: "Attiva",
    companyAddressTitle: "Indirizzo azienda",
    registrationDetailsTitle: "Dati di registrazione",
    taxNumber: "Numero fiscale (DŠ)",
    registrationNumber: "Numero di registrazione (MŠ)",
    registrationDate: "Data di registrazione",
    registerAsCompany: "Registrati come azienda",
    companyInformation: "Informazioni aziendali",
    companyName: "Nome azienda",
    companyAddress: "Indirizzo azienda",
    companyCity: "Città",
    companyCountry: "Paese",
    noCompanyRegistered: "Non hai un'azienda registrata.",
    registerCompany: "Registra azienda",
    editCompanyInfo: "Modifica informazioni aziendali",
    saveCompanyInfo: "Salva informazioni aziendali",
    loadingCompanyInfo: "Caricamento informazioni aziendali...",
    passwordResetRateLimitExceeded: "Puoi reimpostare la password solo una volta al giorno.",
    accountSecurity: "Sicurezza dell'account",
    currentPassword: "Password attuale",
    newPassword: "Nuova password",
    changePassword: "Cambia password",
    forgotPasswordTitle: "Password dimenticata",
    forgotPasswordInstructions: "Inserisci il tuo indirizzo email. Riceverai un'email con un link per reimpostare la password.",
    businessDetailsTitle: "Dettagli aziendali",
    skdActivity: "Attività SKD",
    companySize: "Dimensione azienda",
    registrationAuthority: "Autorità di registrazione",
    vatRegistered: "Soggetto IVA",
    vatYes: "SÌ",
    capitalOrigin: "Origine capitale",
    capitalNotDetermined: "Capitale non determinato",
  ...
  de: {
    ...
    enterTaxNumber: "Steuernummer eingeben",
    enterRegistrationNumber: "Registernummer eingeben",
    enterCompanyAddress: "Firmenadresse eingeben",
    enterCompanyCity: "Stadt eingeben",
    enterCompanyCountry: "Land eingeben",
    ...
    companyInfoPageTitle: "Firmeninformationen - FURA",
    companyNameTitle: "Firmenname",
    companyFullName: "Vollständiger Name:",
    companyStatusTitle: "Firmenstatus",
    companyStatusActive: "Aktiv",
    companyAddressTitle: "Firmenadresse",
    registrationDetailsTitle: "Registrierungsdaten",
    taxNumber: "Steuernummer (DŠ)",
    registrationNumber: "Registernummer (MŠ)",
    ...
    companyCity: "Stadt",
    companyCountry: "Land",
    noCompanyRegistered: "Sie haben kein registriertes Unternehmen.",
    registerCompany: "Unternehmen registrieren",
    editCompanyInfo: "Firmeninformationen bearbeiten",
    saveCompanyInfo: "Firmeninformationen speichern",
    loadingCompanyInfo: "Firmeninformationen werden geladen...",
    passwordResetRateLimitExceeded: "Sie können Ihr Passwort nur einmal täglich zurücksetzen.",
    accountSecurity: "Kontosicherheit",
    currentPassword: "Aktuelles Passwort",
    newPassword: "Neues Passwort",
    changePassword: "Passwort ändern",
    forgotPasswordTitle: "Passwort vergessen",
    forgotPasswordInstructions: "Geben Sie Ihre E-Mail-Adresse ein. Sie erhalten eine E-Mail mit einem Link zum Zurücksetzen des Passworts.",
    businessDetailsTitle: "Geschäftsdaten",
    skdActivity: "SKD-Tätigkeit",
    companySize: "Unternehmensgröße",
    registrationAuthority: "Registrierungsbehörde",
    vatRegistered: "Umsatzsteuerpflichtig",
    vatYes: "JA",
    capitalOrigin: "Kapitalherkunft",
    capitalNotDetermined: "Kapital nicht bestimmt",
  ...
  bs: {
    ...
    vehicleHasRefrigerator: "Vozilo ima hladnjak",
    searchRide: "Pretraži prevoz",
    ...
    about: "O nama",
    companyDetails: "Podaci o preduzeću",
    companyInfoTitle: "Podaci o preduzeću",
    companyInfoPageTitle: "Podaci o preduzeću - FURA",
    companyNameTitle: "Naziv preduzeća",
    companyFullName: "Puni naziv:",
    companyStatusTitle: "Status preduzeća",
    companyStatusActive: "Aktivno",
    companyAddressTitle: "Adresa preduzeća",
    registrationDetailsTitle: "Podaci o registraciji",
    taxNumber: "Poreski broj (DŠ)",
    registrationNumber: "Matični broj (MŠ)",
    registrationDate: "Datum upisa",
    businessDetailsTitle: "Poslovni podaci",
    skdActivity: "SKD djelatnost",
    companySize: "Veličina preduzeća",
    registrationAuthority: "Registarski organ",
    vatRegistered: "Obavezan za PDV",
    vatYes: "DA",
    capitalOrigin: "Porijeklo kapitala",
    ...
    // Company and password translations
    registerAsCompany: "Registriraj se kao preduzeće",
    companyInformation: "Podaci o preduzeću",
    companyName: "Naziv preduzeća",
    companyAddress: "Adresa preduzeća",
    companyCity: "Grad",
    companyCountry: "Zemlja",
    noCompanyRegistered: "Nemate registrovano preduzeće.",
    registerCompany: "Registriraj preduzeće",
    editCompanyInfo: "Uredi podatke o preduzeću",
    saveCompanyInfo: "Sačuvaj podatke o preduzeću",
    loadingCompanyInfo: "Učitavanje podataka o preduzeću...",
    enterCompanyName: "Unesite naziv preduzeća",
    enterTaxNumber: "Unesite poreski broj",
    enterRegistrationNumber: "Unesite matični broj",
    enterCompanyAddress: "Unesite adresu preduzeća",
    enterCompanyCity: "Unesite grad",
    enterCompanyCountry: "Unesite zemlju",
    accountSecurity: "Sigurnost računa",
    currentPassword: "Trenutna šifra",
    newPassword: "Nova šifra",
    enterCurrentPassword: "Unesite trenutnu šifru",
    enterNewPassword: "Unesite novu šifru",
    enterConfirmNewPassword: "Potvrdite novu šifru",
    confirmNewPassword: "Potvrdite novu šifru",
    forgotPassword: "Zaboravili ste šifru?",
    forgotPasswordTitle: "Zaboravljena šifra",
    forgotPasswordInstructions: "Unesite vašu e-mail adresu. Dobićete e-mail sa vezom za resetovanje šifre.",
    passwordResetRateLimitExceeded: "Šifru možete ponovo postaviti samo jednom dnevno.",
  ...
  hr: {
    ...
    companyInfoTitle: "Podaci o poduzeću",
    companyInfoPageTitle: "Podaci o poduzeću - FURA",
    companyNameTitle: "Naziv poduzeća",
    companyFullName: "Puni naziv:",
    companyStatusTitle: "Status poduzeća",
    companyStatusActive: "Aktivno",
    companyAddressTitle: "Adresa poduzeća",
    registrationDetailsTitle: "Podaci o registraciji",
    taxNumber: "Porezni broj (DŠ)",
    registrationNumber: "Matični broj (MŠ)",
    registrationDate: "Datum upisa",
    businessDetailsTitle: "Poslovni podaci",
    skdActivity: "SKD djelatnost",
    companySize: "Veličina poduzeća",
    registrationAuthority: "Registarski organ",
    vatRegistered: "Obveznik za PDV",
    vatYes: "DA",
    capitalOrigin: "Podrijetlo kapitala",
    capitalNotDetermined: "Kapital se ne određuje",
    contactInfoTitle: "Kontakt informacije",
    contact: "Kontakt",
    profile: "Profil",
    ...
    // Company and password translations
    registerAsCompany: "Registriraj se kao poduzeće",
    companyInformation: "Podaci o poduzeću",
    companyName: "Naziv poduzeća",
    companyAddress: "Adresa poduzeća",
    companyCity: "Grad",
    companyCountry: "Zemlja",
    noCompanyRegistered: "Nemate registrirano poduzeće.",
    registerCompany: "Registriraj poduzeće",
    editCompanyInfo: "Uredi podatke o poduzeću",
    saveCompanyInfo: "Spremi podatke o poduzeću",
    loadingCompanyInfo: "Učitavanje podataka o poduzeću...",
    enterCompanyName: "Unesite naziv poduzeća",
    enterTaxNumber: "Unesite porezni broj",
    enterRegistrationNumber: "Unesite matični broj",
    enterCompanyAddress: "Unesite adresu poduzeća",
    enterCompanyCity: "Unesite grad",
    enterCompanyCountry: "Unesite zemlju",
    accountSecurity: "Sigurnost računa",
    ...
    enterConfirmNewPassword: "Potvrdite novu lozinku",
    confirmNewPassword: "Potvrdite novu lozinku",
    changePassword: "Promijeni lozinku",
    forgotPassword: "Zaboravili ste lozinku?",
    forgotPasswordTitle: "Zaboravljena lozinka",
    forgotPasswordInstructions: "Unesite vašu e-mail adresu. Dobićete e-mail sa vezom za resetovanje lozinke.",
    passwordResetRateLimitExceeded: "Lozinku možete ponovo postaviti samo jednom dnevno."
  },
  ...
  me: {
    ...
    // Company and password translations
    registerAsCompany: "Registruj se kao preduzeće",
    companyInformation: "Podaci o preduzeću",
    companyName: "Naziv preduzeća",
    companyAddress: "Adresa preduzeća",
    companyCity: "Grad",
    companyCountry: "Zemlja",
    noCompanyRegistered: "Nemate registrovano preduzeće.",
    registerCompany: "Registruj preduzeće",
    editCompanyInfo: "Uredi podatke o preduzeću",
    saveCompanyInfo: "Sačuvaj podatke o preduzeću",
    loadingCompanyInfo: "Učitavanje podataka o preduzeću...",
    enterCompanyName: "Unesite naziv preduzeća",
